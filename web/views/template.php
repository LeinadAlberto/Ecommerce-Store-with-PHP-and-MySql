    ...
    <body class="hold-transition sidebar-collapse layout-top-nav">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Brand Logo -->
                <a href="<?php echo $path ?>views/assets/index3.html" class="brand-link">
                <img src="<?php echo $path ?>views/assets/img/adminlte/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">AdminLTE 3</span>
                </a>
                ...
                <nav class="mt-2">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $path ?>views/assets/index.html" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Dashboard v1</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $path ?>views/assets/index2.html" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Dashboard v2</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo $path ?>views/assets/index3.html" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Dashboard v3</p>
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo $path ?>views/assets/starter.html" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Starter Page</p>
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $path ?>views/assets/iframe.html" class="nav-link">
