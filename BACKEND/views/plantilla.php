...
<html lang="en">
    ...
    <title>AdminLTE 3 | Starter</title>
        <link rel="shortcut icon" href="views/dist/img/AdminLTELogo.png" type="image/x-icon">
        ...
        <!-- Font Awesome Icons -->
        <link rel="preload" href="views/plugins/fontawesome-free/css/all.min.css" as="style" onload="this.rel='stylesheet'">
        <noscript>
        <link rel="stylesheet" href="views/plugins/fontawesome-free/css/all.min.css">
        </noscript>
        <!-- Theme style -->
        <link rel="preload" href="views/dist/css/adminlte.min.css" as="style" onload="this.rel='stylesheet'">
        <noscript>
